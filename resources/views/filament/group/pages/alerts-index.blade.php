...
<x-filament-panels::page>
    ...
    >
        {{-- `getHeading()` rend une chaine vide pour laisser le hero seul, et
             Filament n'affiche alors NI son en-tete NI les actions d'en-tete :
             un bouton pose sur cette page ne serait jamais rendu. On les
             injecte donc dans le hero, comme le tableau de bord. --}}
        @if (! empty($this->getCachedHeaderActions()))
            <x-slot:actions>
